...
export const Route = createFileRoute("/world/login")({
  head: () => ({
    meta: [
      { title: "World Room — Connexion — Zembo" },
      {
        name: "description",
        content: "Connecte-toi à ton profil World Room.",
      },
      { property: "og:title", content: "World Room — Connexion — Zembo" },
      { property: "og:description", content: "Connecte-toi à ton profil World Room." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
  }),
  component: WorldLogin,
});
    ...
    <div className="app-scroll no-scrollbar flex min-h-[100dvh] flex-col items-center px-6 pt-[max(env(safe-area-inset-top),14px)] text-center">
      ...
      <div className="mt-20 flex flex-col items-center">
        ...
        <p className="mt-4 max-w-[260px] text-[13px] leading-relaxed text-muted-foreground">
          La connexion World Room arrive bientôt. En attendant, retourne à
          l'accueil World Room.
        </p>
